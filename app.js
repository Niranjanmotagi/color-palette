...
const ICONS = {
  donut: `<svg class="donut" viewBox="0 0 32 32"><circle cx="16" cy="16" r="10" fill="none" stroke="#111111" stroke-width="9" stroke-dasharray="55 8"/></svg>`,
...
function initPFC(el) {
  ...
  el.innerHTML = `
    ...
    <div><span class="hex" style="color:#111;font-size:15px;font-family:'Space Mono',monospace;font-weight:700">${base}</span></div>
...
function cardsHTML() {
  return `
  <div class="cards">
    <a class="fcard" style="background:#ffd93d" href="#/trending">Trending Color Palettes</a>
    <a class="fcard" style="background:#ff7aad" href="#/gradients">Awesome Gradients</a>
    <a class="fcard" style="background:#7ce0ff" href="#/tpg">Tailwind Palette Generator</a>
    <a class="fcard tall" style="background:#c9a7ff" href="#/pfi">${ICONS.robot} Palette from Image [AI]</a>
    <a class="fcard tall" style="background:#c9ff6e" href="#/palette-from-color">${ICONS.palette} Color Palette from Color [AI]</a>
    <a class="fcard tall" style="background:#ff9f45" href="#/color-says">${ICONS.cool} What Color Says!</a>
  </div>`;
}
